...
useEffect(() => {
  ...
  setimage(imageone);
    ...
    function colorSelection(){
        ...
        const colorArray = ['#CE1212', '#F6C90E', '#FA8812', '#5ACFA9', '#FF2626', '#31C9C5', '#F0A500', '#FF4C29', '#892CDC', '#FF1E56'];
    ...
    return (
        <div style={{overflow:"hidden !important"}}>
            ...
            <Nav/>
            <Home color={color}/>
            <button style={{borderColor:`${color}`}} className="variation-button" onClick={() => colorSelection()}><img src={Click} alt="click"/></button>
            </div>
            <section>
            <div style={{borderColor:`transparent`}} className="set">
               <div><img src={image} alt="leaf" /></div>
               <div><img src={image} alt="leaf" /></div>
               <div><img src={image} alt="leaf" /></div>
               <div><img src={image} alt="leaf" /></div>
               <div><img src={image} alt="leaf" /></div>
